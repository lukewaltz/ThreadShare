  ...
  return (
    <div className="product-container">
      ...
      <main className="product-details">
        <img src="product2.png" alt='Product 2' className="product-image" />
        <div className="product-info">
          <div className="product-text">
            <h2 className="product-name">Product 2</h2>
            <p className="product-description">This is the description of Product 2. It's a high-quality shirt available for both rent and purchase.</p>
